...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>Crie sua Conta</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <form action="/manager/register" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Nome Completo" name="desname">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="E-mail" name="desemail">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="tel" class="form-control" placeholder="Telefone" name="nrphone">
      ...
      <div class="form-group has-feedback">
        <input id="password" type="password" class="form-control" placeholder="Senha" name="despassword">
    ...
    <a href="/manager/login" class="text-center">Já tenho uma conta</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
