            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td><p> <a href="/manager/participants/<?php echo htmlspecialchars( $value1["idevent"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Ver Lista</a></p></td>
                </tr>  
                </tbody>
                <?php } ?>
              </table>
