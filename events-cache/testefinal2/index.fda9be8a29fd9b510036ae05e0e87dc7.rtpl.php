		...
		<!-- CTA -->
			...
			<section id="contact" class="wrapper style1">
				<div class="container">
					<header class="center">
						<h2>Contato</h2>
						<?php $counter1=-1;  if( isset($contact) && ( is_array($contact) || $contact instanceof Traversable ) && sizeof($contact) ) foreach( $contact as $key1 => $value1 ){ $counter1++; ?>
						<p>E-mail do organizador: <?php echo htmlspecialchars( $value1["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
						<p>Telefone: <?php echo htmlspecialchars( $value1["nrphone"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
						<?php } ?>
					</header>
			...
			<footer id="footer">
				<ul class="icons">
					...
					<li><a href="https://www.facebook.com/<?php echo htmlspecialchars( $event["fb_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" target="_blank" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
					<li><a href="https://www.instagram.com/<?php echo htmlspecialchars( $event["instagram_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" target="_blank" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
				</ul>
